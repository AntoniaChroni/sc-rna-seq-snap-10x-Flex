...
python ${module_dir}/util/summarize_cellranger_results.py --dir=./results/02_cellranger_count/${cellranger_parameters}/multi_run_${cellranger_parameters}/outs/per_sample_outs \
